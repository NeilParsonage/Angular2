...
import com.daimler.emst2.fhi.sendung.action.ActionAllSendHistorienEintragSchreiben;
import com.daimler.emst2.fhi.sendung.action.ActionAllSendbarKnzSetzen;
...
import com.daimler.emst2.fhi.sendung.action.ActionSendeStatusSetzen;
import com.daimler.emst2.fhi.sendung.action.ActionTaktTelegramm;
	...
	public IAction createAction(SendActionEnum pActionEnum) {
		...
		case FHI_TAKT_TELEGRAMM:
			return new ActionTaktTelegramm(SendTypeEnum.FHI, pActionEnum,
					getProtocolService(), taktTelegramDao);
