...
import com.daimler.emst2.fhi.sendung.werk152.config.SendFhiConfiguration;
import com.daimler.emst2.fhi.sendung.werk152.config.SendKomplettConfiguration;
import com.daimler.emst2.fhi.sendung.werk152.config.SendLmtConfiguration;
import com.daimler.emst2.fhi.sendung.werk152.config.SendRhmConfiguration;
import com.daimler.emst2.fhi.sendung.werk152.config.SendUbmConfiguration;
...
public class SendDefinitionFactory implements ISendDefinitionFactory {
    ...
    private void init() {
        ...
        SendUbmConfiguration sendUbmConfig = new SendUbmConfiguration();
        ISend sendUbm = new SendProcess(sendUbmConfig);
        ...
        sendLmt.addChild(sendUbm);
        sendUbm.addChild(sendRhm);
