...
public class CheckFhiVorsendungen extends AbstractSendCheck {

    public CheckFhiVorsendungen(ProtocolService pProtocolService, SendCheckEnum sendCheckStepIdentifier) {
